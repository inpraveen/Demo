...
+ (BFTask *)logInWithUsernameInBackground:(NSString *)username password:(NSString *)password companyID:(NSString *)companyID url:(NSString *)url {
    return [[self userController] logInCurrentUserAsyncWithUsername:username
                                                           password:password
                                                          companyID:companyID
                                                                url:url
...
//new
+ (void)logInWithUsernameInBackground:(NSString *)username password:(NSString *)password companyID:(NSString *)companyID  url:(NSString *)url  block:(nullable PFUserResultBlock)block
{
    [[self logInWithUsernameInBackground:username password:password companyID:companyID url:url] thenCallBackOnMainThreadAsync:block];
