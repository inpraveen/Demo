...
//        tableView.frame = CGRect(x: 0, y: 0, width: width, height: height / 1.096 - self.navigationController!.navigationBar.frame.size.height - 20)
        tableView.frame = CGRect(x: 0, y: 0, width: width, height: height / 1.096 - self.navigationController!.navigationBar.frame.size.height - 50)
  ...
  @objc  func loadMore() {
    ...
    // clicked send button
    @IBAction func sendCommentBtn_click(_ sender: AnyObject) {
